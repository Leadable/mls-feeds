BEGIN;
  ...
  CREATE TABLE cmls2."Media"() ;
    ALTER TABLE cmls2."Media" ADD COLUMN "Order" integer;
    COMMENT ON COLUMN cmls2."Media"."Order" IS 'Order';
     
    ALTER TABLE cmls2."Media" ADD COLUMN "ModifiedDate" text;
    COMMENT ON COLUMN cmls2."Media"."ModifiedDate" IS 'Modified Date';
     
    ALTER TABLE cmls2."Media" ADD COLUMN "matrix_unique_id" bigint PRIMARY KEY;
    COMMENT ON COLUMN cmls2."Media"."matrix_unique_id" IS 'Matrix Unique Id';
     
    ALTER TABLE cmls2."Media" ADD COLUMN "Description" text;
    COMMENT ON COLUMN cmls2."Media"."Description" IS 'Description';
     
    ALTER TABLE cmls2."Media" ADD COLUMN "Type" text;
    COMMENT ON COLUMN cmls2."Media"."Type" IS 'Type';
     
  CREATE TABLE cmls2."Agent"() ;
