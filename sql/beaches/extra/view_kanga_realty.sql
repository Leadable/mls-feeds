...
CREATE VIEW beaches.view_kanga_realty_mv AS SELECT * FROM beaches.view_kanga_realty;
CREATE VIEW beaches.view_kanga_realty_mv_active as SELECT * FROM beaches.view_kanga_realty WHERE __active;
