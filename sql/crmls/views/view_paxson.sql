...
CREATE OR REPLACE VIEW crmls.view_paxson AS
  SELECT
   ...
   vl.*,
   array(select jsonb_array_elements_text(__geo_places#>'{41,"Neighborhood"}')::text) as __geo_neigh
  FROM
    crmls.view_property vl
;

--ST_Within(__geo_geom, ST_SetSRID(''::geometry,4326))
