...
CREATE VIEW crmls.view_donovan_mv AS SELECT * FROM crmls.view_donovan;
CREATE VIEW crmls.view_donovan_mv_active as SELECT * FROM crmls.view_donovan WHERE __active;
