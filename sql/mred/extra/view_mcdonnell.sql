...
CREATE VIEW mred.view_mcdonnell_mv AS SELECT * FROM beaches.view_mcdonnell;
CREATE VIEW mred.view_mcdonnell_mv_active as SELECT * FROM beaches.view_mcdonnell WHERE __active;