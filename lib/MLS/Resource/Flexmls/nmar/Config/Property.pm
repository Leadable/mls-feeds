package MLS::Resource::Flexmls::nmar::Config::Property;
use strict;

use MLS::Resource::Flexmls::nmar::Config;
use MLS::Resource::Utils;

# ID of the Rets Property Resource
$MLS::Config::RESOURCE = 'Property';

@MLS::Config::AREAS = qw(rich);
...
%MLS::Config::CLASSES = (
  ...
  D => { StandardName => 'MultiFamily',          'SearchRequest' => $search, ignore => 1 },
  E => { StandardName => 'Agricultural',         'SearchRequest' => $search, ignore => 1 },
  F => { StandardName => 'Business Opportunity', 'SearchRequest' => $search, ignore => 1 },
  G => { StandardName => 'Misc. Property',       'SearchRequest' => $search },
  H => { StandardName => 'Commercial Lease',     'SearchRequest' => $search, ignore => 1 },
);
