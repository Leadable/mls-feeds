package MLS::Resource::Paragon::tricitymls2::Config::Property;
use strict;

use MLS::Resource::Paragon::tricitymls2::Config;

# ID of the Rets Property Resource
$MLS::Config::RESOURCE = 'Property';

@MLS::Config::AREAS = qw(lane);
...
%MLS::Config::CLASSES = (
    ...
    CI_3 => { StandardName => 'CommonInterest',      'SearchRequest' => $search, ignore => 1 },
    MF_4 => { StandardName => 'MultiFamily',         'SearchRequest' => $search, ignore => 1 },
    CT_5 => { StandardName => 'ResidentialProperty', 'SearchRequest' => $search, ignore => 1 },
);
