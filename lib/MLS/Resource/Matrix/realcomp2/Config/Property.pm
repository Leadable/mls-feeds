package MLS::Resource::Matrix::realcomp2::Config::Property;
use strict;

use MLS::Resource::Matrix::realcomp2::Config;
use MLS::Resource::Utils;

# ID of the Rets Property Resource
$MLS::Config::RESOURCE = 'Property';

@MLS::Config::AREAS = qw(gould);
...
%MLS::Config::CLASSES = (
  ...
  VACANTLAND => { StandardName => 'VacantLand',          'SearchRequest' => $search },
