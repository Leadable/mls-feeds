...
=head1 02_sync_rows.pl

=head1 SYNOPSIS

02_sync_rows.pl [options]
...
B<This program> downloads all data for listings that has been added, updated, or resurrected
